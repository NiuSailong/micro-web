...
class ModelTree extends Component {
  ...
  onChange = (checkedValues) => {
    let arrRender = [];
    let arrTitle = [...this.state.titleCheck];
    ...
    this.setState({
      indeterminate: checkedValues.length === 0 ? false : true,
  ...
  delList = (data) => {
    let objarr = this.state.checkedList;
    let rightRen = this.state.rightRender;
    let obj = { ...this.state.saveValue };
    ...
    this.setState({
      ...
      indeterminate: objarr.length !== 0 ? true : false,
      checkAll: objarr.length !== 0 ? true : false,
      saveValue: obj,
    });
  };
